...
loadScript("https://www.googletagmanager.com/gtag/js?id=G-S3PS0VR20X");

window.dataLayer = window.dataLayer || [];
function gtag(){dataLayer.push(arguments);}
gtag('js', new Date());
gtag('config', 'G-S3PS0VR20X');
...
// (window,"UA-152861272-6",{anonymizeIp:true,colorDepth:true,characterSet:true,screenSize:true,language:true});

var indexText = "Time scale and crop masks"; //Título no desplegado
var chooseText = "Time scale and crop masks"; //Título desplegado
